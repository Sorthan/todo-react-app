...
import { WindSongType } from '../../services/text-typed'
...
const StyledText = styled.div<{
  ...
  font-family: ${({ family }) => `WindSong${family}`};
...
const WindSong = forwardRef((props: TextProps, ref: any) => {
  const {
    children,
    type,
    size,
